...
fun ExpensesTotalHeader(total: Double) {
    Card(shape = RoundedCornerShape(30), backgroundColor = Color.Black, elevation = 5.dp) {
        Box(                   //Toma todo el ancho de la pantalla
            modifier = Modifier.fillMaxWidth().height(130.dp)
                .padding(16.dp),//Se establece la altura y ancho de la pantalla
            ...
            Text(modifier = Modifier.align(Alignment.CenterEnd), text = "PESOS", color = Color.Gray)
        }
    }
}
